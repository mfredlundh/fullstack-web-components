describe('TextInputComponent', () => {
    it('should display error message on blur', () => {
        cy.visit('iframe.html?id=components-input-textinput--form&viewMode=story');
        ...
        cy.get('#root')
            ...
            .shadow()
            .find('.message')
            .contains('Error: Minimum length not met, please supply a value with at least 8 characters.');
    });
